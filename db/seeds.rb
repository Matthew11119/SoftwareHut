...
Criterium.find_or_create_by(criteria_description: "Example criteria 1", criteria_critical: false, station_id: 1)
Criterium.find_or_create_by(criteria_description: "Example criteria 2", criteria_critical: false, station_id: 1)
Criterium.find_or_create_by(criteria_description: "Example criteria 3", criteria_critical: true, station_id: 1)
Criterium.find_or_create_by(criteria_description: "Example criteria 4", criteria_critical: false, station_id: 1)
...
Criterium.find_or_create_by(criteria_description: "Example criteria 5", criteria_critical: false, station_id: 2)
Criterium.find_or_create_by(criteria_description: "Example criteria 6", criteria_critical: false, station_id: 2)
