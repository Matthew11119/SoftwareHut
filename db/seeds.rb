...
User.create(username: "aca18mjl", user_type:"Module Lead")
...
Exam.find_or_create_by(date:'2019-04-26', exam_code:'EX0001', module_code:'COM1001', name:'Examination name 01', status:1)
