...
Exam.create(date:'2019-3-26', exam_code:'EX001',module_code:'COM1001',name:'Examination name 1')
Exam.create(date:'2019-3-26', exam_code:'EX002',module_code:'COM1002',name:'Examination name 2')
Exam.create(date:'2019-3-26', exam_code:'EX003',module_code:'COM1003',name:'Examination name 3')
Exam.create(date:'2019-3-26', exam_code:'EX004',module_code:'COM1002',name:'Examination name 4')
Exam.create(date:'2019-3-26', exam_code:'EX005',module_code:'COM1003',name:'Examination name 5')
Exam.create(date:'2019-3-26', exam_code:'EX006',module_code:'COM1001',name:'Examination name 6')
Exam.create(date:'2019-3-26', exam_code:'EX007',module_code:'COM1002',name:'Examination name 7')
Exam.create(date:'2019-3-26', exam_code:'EX008',module_code:'COM1003',name:'Examination name 8')
Exam.create(date:'2019-3-26', exam_code:'EX009',module_code:'COM1003',name:'Examination name 9')
Exam.create(date:'2019-3-26', exam_code:'EX010',module_code:'COM1002',name:'Examination name 10')
Exam.create(date:'2019-3-25', exam_code:'EX011',module_code:'COM1003',name:'Examination name 11')
Exam.create(date:'2019-3-25', exam_code:'EX012',module_code:'COM1002',name:'Examination name 12')
...
Station.create(exam_code:'EX002',pass_mark:70,station_name:'station name 1 ex002')
Station.create(exam_code:'EX002',pass_mark:70,station_name:'station name 2 ex002')
Station.create(exam_code:'EX002',pass_mark:70,station_name:'station name 3 ex002')
